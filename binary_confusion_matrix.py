...
def fairness_disparate_impact(cm1: BinaryConfusionMatrix, cm2: BinaryConfusionMatrix) -> float:
...
def print_scenario(cm1: BinaryConfusionMatrix, cm2: BinaryConfusionMatrix):
    ...
    fdi = fairness_disparate_impact(cm1, cm2)
    np.seterr(divide='warn', invalid='warn')
    print(f"TE: {te.item()}, DI: {di.item()}, FDI: {fdi}")
    return te, di, fdi
