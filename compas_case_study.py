...
def compas_ethnicity():
    ...
    for ethn1 in stats.columns:
        for ethn2 in stats.columns:
            ...
            fdi = stats[ethn1]["FDI"] - stats[ethn2]["FDI"]
            pp = stats[ethn1]["PP"] - stats[ethn2]["PP"]
            ethn_pairs[(ethn1, ethn2)] = {"TE": te, "DI": di, "FDI": fdi, "PP": pp}
    ...
    pivot_FDI = ethn_pairs.pivot(index="Ethnicity i", columns="Ethnicity j", values="FDI")
    ...
    sns.heatmap(pivot_FDI, annot=True, cmap="coolwarm", ax=ax[3])
